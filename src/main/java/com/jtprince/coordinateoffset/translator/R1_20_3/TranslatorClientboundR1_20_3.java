...
public class TranslatorClientboundR1_20_3 extends Translator.Clientbound {
    ...
    private Map<PacketType, BiFunction<PacketContainer, Offset, PacketContainer>> getTranslators() {
        ...
        map.put(PacketType.Play.Server.LOOK_AT, PacketContainerUtils::sendDouble3D); // 0x3D
        map.put(PacketType.Play.Server.POSITION, PacketContainerUtils::sendPossiblyRelativePosition); // 0x3E
        map.put(PacketType.Play.Server.RESPAWN, (pkt, offset) -> // 0x45
                PacketContainerUtils.sendDeathLocation1_20_2(pkt, offset, 0)
        );
        map.put(PacketType.Play.Server.MULTI_BLOCK_CHANGE, PacketContainerUtils::sendSectionPosition); // 0x47
        map.put(PacketType.Play.Server.VIEW_CENTRE, PacketContainerUtils::sendChunkCoordinate); // 0x52
        map.put(PacketType.Play.Server.SPAWN_POSITION, PacketContainerUtils::sendBlockPosition); // 0x54
        map.put(PacketType.Play.Server.ENTITY_METADATA, EntityMetadataUtils::sendEntityMetadata1_19_3); // 0x56
        map.put(PacketType.Play.Server.NAMED_SOUND_EFFECT, PacketContainerUtils::sendInt3DTimes8); // 0x66
        map.put(PacketType.Play.Server.ENTITY_TELEPORT, PacketContainerUtils::sendDouble3D); // 0x6D
